import{j as _}from"./animation-DPP9jQnv.js";import{a as k,c as I}from"./utils-CDN07tui.js";import{r as i,R as C}from"./react-vendor-B2xCQPYh.js";const y=e=>typeof e=="boolean"?`${e}`:e===0?"0":e,b=k,S=(e,t)=>n=>{var o;if(t?.variants==null)return b(e,n?.class,n?.className);const{variants:r,defaultVariants:a}=t,c=Object.keys(r).map(s=>{const d=n?.[s],u=a?.[s];if(d===null)return null;const m=y(d)||y(u);return r[s][m]}),l=n&&Object.entries(n).reduce((s,d)=>{let[u,m]=d;return m===void 0||(s[u]=m),s},{}),p=t==null||(o=t.compoundVariants)===null||o===void 0?void 0:o.reduce((s,d)=>{let{class:u,className:m,...w}=d;return Object.entries(w).every(A=>{let[h,f]=A;return Array.isArray(f)?f.includes({...a,...l}[h]):{...a,...l}[h]===f})?[...s,u,m]:s},[]);return b(e,c,p,n?.class,n?.className)},L=S("inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",{variants:{variant:{default:"border-transparent bg-primary text-primary-foreground shadow hover:bg-primary/80",secondary:"border-transparent bg-secondary text-secondary-foreground hover:bg-secondary/80",destructive:"border-transparent bg-destructive text-destructive-foreground shadow hover:bg-destructive/80",outline:"text-foreground"}},defaultVariants:{variant:"default"}});function zt({className:e,variant:t,...n}){return _.jsx("div",{className:I(L({variant:t}),e),...n})}function x(e,t){if(typeof e=="function")return e(t);e!=null&&(e.current=t)}function P(...e){return t=>{let n=!1;const o=e.map(r=>{const a=x(r,t);return!n&&typeof a=="function"&&(n=!0),a});if(n)return()=>{for(let r=0;r<o.length;r++){const a=o[r];typeof a=="function"?a():x(e[r],null)}}}}var M=Symbol.for("react.lazy"),g=C[" use ".trim().toString()];function q(e){return typeof e=="object"&&e!==null&&"then"in e}function v(e){return e!=null&&typeof e=="object"&&"$$typeof"in e&&e.$$typeof===M&&"_payload"in e&&q(e._payload)}function T(e){const t=R(e),n=i.forwardRef((o,r)=>{let{children:a,...c}=o;v(a)&&typeof g=="function"&&(a=g(a._payload));const l=i.Children.toArray(a),p=l.find(N);if(p){const s=p.props.children,d=l.map(u=>u===p?i.Children.count(s)>1?i.Children.only(null):i.isValidElement(s)?s.props.children:null:u);return _.jsx(t,{...c,ref:r,children:i.isValidElement(s)?i.cloneElement(s,void 0,d):null})}return _.jsx(t,{...c,ref:r,children:a})});return n.displayName=`${e}.Slot`,n}var Ft=T("Slot");function R(e){const t=i.forwardRef((n,o)=>{let{children:r,...a}=n;if(v(r)&&typeof g=="function"&&(r=g(r._payload)),i.isValidElement(r)){const c=z(r),l=D(a,r.props);return r.type!==i.Fragment&&(l.ref=o?P(o,c):c),i.cloneElement(r,l)}return i.Children.count(r)>1?i.Children.only(null):null});return t.displayName=`${e}.SlotClone`,t}var E=Symbol("radix.slottable");function N(e){return i.isValidElement(e)&&typeof e.type=="function"&&"__radixId"in e.type&&e.type.__radixId===E}function D(e,t){const n={...t};for(const o in t){const r=e[o],a=t[o];/^on[A-Z]/.test(o)?r&&a?n[o]=(...l)=>{const p=a(...l);return r(...l),p}:r&&(n[o]=r):o==="style"?n[o]={...r,...a}:o==="className"&&(n[o]=[r,a].filter(Boolean).join(" "))}return{...e,...n}}function z(e){let t=Object.getOwnPropertyDescriptor(e.props,"ref")?.get,n=t&&"isReactWarning"in t&&t.isReactWarning;return n?e.ref:(t=Object.getOwnPropertyDescriptor(e,"ref")?.get,n=t&&"isReactWarning"in t&&t.isReactWarning,n?e.props.ref:e.props.ref||e.ref)}const F="6",O="building-rag-system-python-chromadb",B="Building a Production-Ready RAG System with Python and ChromaDB",G="Learn how to build an intelligent document processing system using Retrieval-Augmented Generation, ChromaDB vector database, and Phi-3 LLM for accurate AI-powered summaries.",$=`# Building a Production-Ready RAG System
...
`,H="/blog/rag-system.png",U={name:"Abhishek Mane",photo:"/Abhishek_Profile.png"},W="2024-12-20",V=8,j="AI/ML",Q=["RAG","Python","ChromaDB","LLM","AI"],Y=!1,K={id:F,slug:O,title:B,excerpt:G,content:$,featuredImage:H,author:U,publishedAt:W,readTime:V,category:j,tags:Q,featured:Y},X="2",Z="fastapi-production-best-practices",J="FastAPI in Production: Best Practices and Lessons Learned",ee="Practical insights from building and deploying FastAPI applications at scale, including async patterns, error handling, security, and performance optimization.",ne=`# FastAPI in Production: Best Practices
...
`,Le="2025-02-05",Pe=10,Me={name:"Abhishek Mane",photo:"/Abhishek_Profile.png"},qe="Infrastructure",Te=["Nginx","FastAPI","DevOps","Production","Architecture"],Re="/blog/Guide_to_Nginx_FastAPI_and_DNS_Integration.png",Ee=!1,Ne={id:Ae,slug:ke,title:Ie,excerpt:Ce,content:Se,publishedAt:Le,readTime:Pe,author:Me,category:qe,tags:Te,featuredImage:Re,featured:Ee},De="10",ze="context-engineering-guide",Fe="Context Engineering: The Architect's Guide to Intelligent Information Management",Oe="Learn how to master context engineering to build smarter, more reliable AI systems that understand intent and provide relevant, grounded responses.",Be=`# Context Engineering: The Architect's Guide to Intelligent Information Management for AI Systems
...
`,Ge="2025-02-04",$e=15,He={name:"Abhishek Mane",photo:"/Abhishek_Profile.png"},Ue="AI/ML",We=["Context Engineering","RAG","LLM","Data Pipeline","AI Strategy"],Ve="/blog/context-engineering.png",je=!1,Qe={id:De,slug:ze,title:Fe,excerpt:Oe,content:Be,publishedAt:Ge,readTime:$e,author:He,category:Ue,tags:We,featuredImage:Ve,featured:je},Ye="5",Ke="enterprise-rag-systems-guide",Xe="Building Enterprise-Grade RAG Systems: From Prototype to Production",Ze="A comprehensive guide to building scalable, reliable RAG systems using LangChain, Azure AI Foundry, and hybrid search techniques for production environments.",Je=`# Building Enterprise-Grade RAG Systems: From Prototype to Production
...
`,en="/blog/enterprise-rag.png",nn={name:"Abhishek Mane",photo:"/Abhishek_Profile.png"},tn="2025-01-28",rn=12,an="AI/ML",on=["RAG","LangChain","Azure AI","Vector DB"],sn=!1,ln={id:Ye,slug:Ke,title:Xe,excerpt:Ze,content:Je,featuredImage:en,author:nn,publishedAt:tn,readTime:rn,category:an,tags:on,featured:sn},cn="1",dn="llmops-production-guide",un="LLMOps: Engineering Production-Grade AI Systems That Actually Work",pn="Master the lifecycle of Large Language Model operations, from prompt versioning and automated evaluation to canary deployments and cost optimization.",mn=`# LLMOps: Engineering Production-Grade AI Systems That Actually Work
...
`,Sn="2025-01-30",Ln=11,Pn={name:"Abhishek Mane",photo:"/Abhishek_Profile.png"},Mn="Computer Vision",qn=["Multimodal","Computer Vision","NLP","AI Architecture","Azure"],Tn="/blog/multimodal-ai.png",Rn=!1,En={id:wn,slug:An,title:kn,excerpt:In,content:Cn,publishedAt:Sn,readTime:Ln,author:Pn,category:Mn,tags:qn,featuredImage:Tn,featured:Rn},Nn="12",Dn="ai-agent-protocols-mcp",zn="AI Agent Communication Protocols: MCP, Tool Integration, and Standards",Fn="Exploring the Model Context Protocol (MCP) and other standards that enable AI agents to communicate and share tools across different platforms.",On=`# AI Agent Communication Protocols: MCP, Tool Integration, and Standards
...
`,Bn="2025-02-06",Gn=9,$n={name:"Abhishek Mane",photo:"/Abhishek_Profile.png"},Hn="AI Frameworks",Un=["MCP","AI Agents","Protocols","Standards","Tool Integration"],Wn="/blog/ai-agent-protocols.png",Vn=!1,jn={id:Nn,slug:Dn,title:zn,excerpt:Fn,content:On,publishedAt:Bn,readTime:Gn,author:$n,category:Hn,tags:Un,featuredImage:Wn,featured:Vn},Qn="7",Yn="small-language-models-efficiency",Kn="Small Language Models: Building Efficient AI That Actually Ships",Xn="Discover why smaller is often better. A technical deep dive into fine-tuning 1-10B parameter models like Phi-3.5 and Llama 3.2 for specialized, low-latency tasks.",Zn=`# Small Language Models: Building Efficient AI That Actually Ships
...
`,Jn="2025-01-20",et=8,nt={name:"Abhishek",photo:"/Abhishek_Profile.png"},tt="Edge AI",rt=["SLM","Edge AI","Optimization","Phi-3.5"],at="/blog/small-language-models.png",ot=!1,st={id:Qn,slug:Yn,title:Kn,excerpt:Xn,content:Zn,publishedAt:Jn,readTime:et,author:nt,category:tt,tags:rt,featuredImage:at,featured:ot},it="14",lt="agentic-ai-production-guide",ct="Agentic AI in Production: From Research Hype to Business Reality",dt="Master the architecture of autonomous AI agents. Learn to build reliable, goal-oriented systems using ReAct patterns, multi-agent coordination, and production-grade tool integration.",ut=`# Agentic AI in Production: From Research Hype to Business Reality
...
`,It="2025-02-01",Ct=13,St={name:"Abhishek Mane",photo:"/Abhishek_Profile.png"},Lt="DevOps",Pt=["Observability","Monitoring","AI Production","DevOps","Tracing"],Mt="/blog/ai-observability.png",qt=!1,Tt={id:xt,slug:vt,title:wt,excerpt:At,content:kt,publishedAt:It,readTime:Ct,author:St,category:Lt,tags:Pt,featuredImage:Mt,featured:qt},Rt=[K,ce,we,Ne,Qe,ln,vn,En,jn,st,bt,Tt].sort((e,t)=>parseInt(e.id)-parseInt(t.id));function Ot(e){return Rt.find(t=>t.slug===e)}export{zt as B,Ft as S,S as a,Rt as b,T as c,Ot as g};
