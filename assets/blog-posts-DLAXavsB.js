import{j as _}from"./animation-DPP9jQnv.js";import{a as k,c as C}from"./utils-CDN07tui.js";import{r as i,R as S}from"./react-vendor-B2xCQPYh.js";const y=n=>typeof n=="boolean"?`${n}`:n===0?"0":n,v=k,I=(n,t)=>e=>{var o;if(t?.variants==null)return v(n,e?.class,e?.className);const{variants:r,defaultVariants:s}=t,c=Object.keys(r).map(a=>{const u=e?.[a],d=s?.[a];if(u===null)return null;const p=y(u)||y(d);return r[a][p]}),l=e&&Object.entries(e).reduce((a,u)=>{let[d,p]=u;return p===void 0||(a[d]=p),a},{}),m=t==null||(o=t.compoundVariants)===null||o===void 0?void 0:o.reduce((a,u)=>{let{class:d,className:p,...A}=u;return Object.entries(A).every(w=>{let[h,g]=w;return Array.isArray(g)?g.includes({...s,...l}[h]):{...s,...l}[h]===g})?[...a,d,p]:a},[]);return v(n,c,m,e?.class,e?.className)},L=I("inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",{variants:{variant:{default:"border-transparent bg-primary text-primary-foreground shadow hover:bg-primary/80",secondary:"border-transparent bg-secondary text-secondary-foreground hover:bg-secondary/80",destructive:"border-transparent bg-destructive text-destructive-foreground shadow hover:bg-destructive/80",outline:"text-foreground"}},defaultVariants:{variant:"default"}});function Ft({className:n,variant:t,...e}){return _.jsx("div",{className:C(L({variant:t}),n),...e})}function b(n,t){if(typeof n=="function")return n(t);n!=null&&(n.current=t)}function M(...n){return t=>{let e=!1;const o=n.map(r=>{const s=b(r,t);return!e&&typeof s=="function"&&(e=!0),s});if(e)return()=>{for(let r=0;r<o.length;r++){const s=o[r];typeof s=="function"?s():b(n[r],null)}}}}var P=Symbol.for("react.lazy"),f=S[" use ".trim().toString()];function T(n){return typeof n=="object"&&n!==null&&"then"in n}function x(n){return n!=null&&typeof n=="object"&&"$$typeof"in n&&n.$$typeof===P&&"_payload"in n&&T(n._payload)}function R(n){const t=E(n),e=i.forwardRef((o,r)=>{let{children:s,...c}=o;x(s)&&typeof f=="function"&&(s=f(s._payload));const l=i.Children.toArray(s),m=l.find(D);if(m){const a=m.props.children,u=l.map(d=>d===m?i.Children.count(a)>1?i.Children.only(null):i.isValidElement(a)?a.props.children:null:d);return _.jsx(t,{...c,ref:r,children:i.isValidElement(a)?i.cloneElement(a,void 0,u):null})}return _.jsx(t,{...c,ref:r,children:s})});return e.displayName=`${n}.Slot`,e}var zt=R("Slot");function E(n){const t=i.forwardRef((e,o)=>{let{children:r,...s}=e;if(x(r)&&typeof f=="function"&&(r=f(r._payload)),i.isValidElement(r)){const c=F(r),l=N(s,r.props);return r.type!==i.Fragment&&(l.ref=o?M(o,c):c),i.cloneElement(r,l)}return i.Children.count(r)>1?i.Children.only(null):null});return t.displayName=`${n}.SlotClone`,t}var q=Symbol("radix.slottable");function D(n){return i.isValidElement(n)&&typeof n.type=="function"&&"__radixId"in n.type&&n.type.__radixId===q}function N(n,t){const e={...t};for(const o in t){const r=n[o],s=t[o];/^on[A-Z]/.test(o)?r&&s?e[o]=(...l)=>{const m=s(...l);return r(...l),m}:r&&(e[o]=r):o==="style"?e[o]={...r,...s}:o==="className"&&(e[o]=[r,s].filter(Boolean).join(" "))}return{...n,...e}}function F(n){let t=Object.getOwnPropertyDescriptor(n.props,"ref")?.get,e=t&&"isReactWarning"in t&&t.isReactWarning;return e?n.ref:(t=Object.getOwnPropertyDescriptor(n,"ref")?.get,e=t&&"isReactWarning"in t&&t.isReactWarning,e?n.props.ref:n.props.ref||n.ref)}const z="6",B="building-rag-system-python-chromadb",G="Building a Production-Ready RAG System with Python and ChromaDB",O="Learn how to build an intelligent document processing system using Retrieval-Augmented Generation, ChromaDB vector database, and Phi-3 LLM for accurate AI-powered summaries.",H=`# Building a Production-Ready RAG System
...
`,$="/blog/rag-system.png",U={name:"Abhishek Mane",photo:"/Abhishek_Profile.png"},W="2024-12-20",V=8,K="AI/ML",Q=["RAG","Python","ChromaDB","LLM","AI"],j=!1,Y={id:z,slug:B,title:G,excerpt:O,content:H,featuredImage:$,author:U,publishedAt:W,readTime:V,category:K,tags:Q,featured:j},J="2",X="fastapi-production-best-practices",Z="FastAPI in Production: Best Practices and Lessons Learned",nn="Practical insights from building and deploying FastAPI applications at scale, including async patterns, error handling, security, and performance optimization.",en=`# FastAPI in Production: Best Practices
...
`,tn="/blog/fastapi.png",rn={name:"Abhishek Mane",photo:"/Abhishek_Profile.png"},sn="2024-11-15",on=10,an="Backend",ln=["FastAPI","Python","Backend","API","Performance"],cn=!0,un={id:J,slug:X,title:Z,excerpt:nn,content:en,featuredImage:tn,author:rn,publishedAt:sn,readTime:on,category:an,tags:ln,featured:cn},dn="4",mn="multi-agent-systems-langgraph-guide",pn="Building Production-Ready Multi-Agent Systems with LangGraph",fn="A comprehensive technical guide to orchestrating specialized AI agents using LangGraph and LangChain for scalable, stateful production workflows.",gn=`# Building Production-Ready Multi-Agent Systems with LangGraph: A Complete Technical Guide
...
`,_n="/blog/multi-agent-systems.png",hn={name:"Abhishek Mane",photo:"/Abhishek_Profile.png"},yn="2025-01-15",vn=12,bn="AI/ML",xn=["LangGraph","Multi-Agent","Python","AI Architecture","LangChain"],An=!0,wn={id:dn,slug:mn,title:pn,excerpt:fn,content:gn,featuredImage:_n,author:hn,publishedAt:yn,readTime:vn,category:bn,tags:xn,featured:An},kn="9",Cn="production-architecture-nginx-fastapi",Sn="Production-Ready AI Architecture: Nginx, FastAPI, and DNS Integration",In="A technical blueprint for deploying AI applications with high availability, secure DNS, and efficient load balancing using Nginx and FastAPI.",Ln=`# System Architecture for Production AI Applications: Complete Guide to Nginx, FastAPI, and DNS Integration
...
`,Mn="2025-02-05",Pn=10,Tn={name:"Abhishek Mane",photo:"/Abhishek_Profile.png"},Rn="Infrastructure",En=["Nginx","FastAPI","DevOps","Production","Architecture"],qn="/blog/Guide_to_Nginx_FastAPI_and_DNS_Integration.png",Dn=!1,Nn={id:kn,slug:Cn,title:Sn,excerpt:In,content:Ln,publishedAt:Mn,readTime:Pn,author:Tn,category:Rn,tags:En,featuredImage:qn,featured:Dn},Fn="10",zn="context-engineering-guide",Bn="Context Engineering: The Architect's Guide to Intelligent Information Management",Gn="Learn how to master context engineering to build smarter, more reliable AI systems that understand intent and provide relevant, grounded responses.",On=`# Context Engineering: The Architect's Guide to Intelligent Information Management for AI Systems
...
`,Hn="2025-02-04",$n=15,Un={name:"Abhishek Mane",photo:"/Abhishek_Profile.png"},Wn="AI/ML",Vn=["Context Engineering","RAG","LLM","Data Pipeline","AI Strategy"],Kn="/blog/context-engineering.png",Qn=!1,jn={id:Fn,slug:zn,title:Bn,excerpt:Gn,content:On,publishedAt:Hn,readTime:$n,author:Un,category:Wn,tags:Vn,featuredImage:Kn,featured:Qn},Yn="5",Jn="enterprise-rag-systems-guide",Xn="Building Enterprise-Grade RAG Systems: From Prototype to Production",Zn="A comprehensive guide to building scalable, reliable RAG systems using LangChain, Azure AI Foundry, and hybrid search techniques for production environments.",ne=`# Building Enterprise-Grade RAG Systems: From Prototype to Production
...
`,ee="/blog/enterprise-rag.png",te={name:"Abhishek Mane",photo:"/Abhishek_Profile.png"},re="2025-01-28",se=12,oe="AI/ML",ae=["RAG","LangChain","Azure AI","Vector DB"],ie=!1,le={id:Yn,slug:Jn,title:Xn,excerpt:Zn,content:ne,featuredImage:ee,author:te,publishedAt:re,readTime:se,category:oe,tags:ae,featured:ie},ce="1",ue="llmops-production-guide",de="LLMOps: Engineering Production-Grade AI Systems That Actually Work",me="Master the lifecycle of Large Language Model operations, from prompt versioning and automated evaluation to canary deployments and cost optimization.",pe=`# LLMOps: Engineering Production-Grade AI Systems That Actually Work
...
`,fe={name:"Abhishek",photo:"/Abhishek_Profile.png"},ge="2025-01-25",_e=10,he="LLMOps",ye=["LLMOps","Production","Monitoring","Azure"],ve="/blog/llmops-production.png",be=!0,xe={id:ce,slug:ue,title:de,excerpt:me,content:pe,author:fe,publishedAt:ge,readTime:_e,category:he,tags:ye,featuredImage:ve,featured:be},Ae="11",we="multimodal-ai-architecture",ke="Multimodal AI Systems: Architecture for Vision, Language, and Beyond",Ce="A deep dive into building AI systems that can see, hear, and speak, exploring the architecture and implementation of multimodal models.",Se=`# Multimodal AI Systems: Architecture for Vision, Language, and Beyond
...
`,Ie="2025-01-30",Le=11,Me={name:"Abhishek Mane",photo:"/Abhishek_Profile.png"},Pe="Computer Vision",Te=["Multimodal","Computer Vision","NLP","AI Architecture","Azure"],Re="/blog/multimodal-ai.png",Ee=!1,qe={id:Ae,slug:we,title:ke,excerpt:Ce,content:Se,publishedAt:Ie,readTime:Le,author:Me,category:Pe,tags:Te,featuredImage:Re,featured:Ee},De="12",Ne="ai-agent-protocols-mcp",Fe="AI Agent Communication Protocols: MCP, Tool Integration, and Standards",ze="Exploring the Model Context Protocol (MCP) and other standards that enable AI agents to communicate and share tools across different platforms.",Be=`# AI Agent Communication Protocols: MCP, Tool Integration, and Standards
...
`,Ge="2025-02-06",Oe=9,He={name:"Abhishek Mane",photo:"/Abhishek_Profile.png"},$e="AI Frameworks",Ue=["MCP","AI Agents","Protocols","Standards","Tool Integration"],We="/blog/ai-agent-protocols.png",Ve=!1,Ke={id:De,slug:Ne,title:Fe,excerpt:ze,content:Be,publishedAt:Ge,readTime:Oe,author:He,category:$e,tags:Ue,featuredImage:We,featured:Ve},Qe="7",je="small-language-models-efficiency",Ye="Small Language Models: Building Efficient AI That Actually Ships",Je="Discover why smaller is often better. A technical deep dive into fine-tuning 1-10B parameter models like Phi-3.5 and Llama 3.2 for specialized, low-latency tasks.",Xe=`# Small Language Models: Building Efficient AI That Actually Ships
...
`,Ze="2025-01-20",nt=8,et={name:"Abhishek",photo:"/Abhishek_Profile.png"},tt="Edge AI",rt=["SLM","Edge AI","Optimization","Phi-3.5"],st="/blog/small-language-models.png",ot=!1,at={id:Qe,slug:je,title:Ye,excerpt:Je,content:Xe,publishedAt:Ze,readTime:nt,author:et,category:tt,tags:rt,featuredImage:st,featured:ot},it="8",lt="agentic-ai-production-reality",ct="Agentic AI in Production: From Research Hype to Business Reality",ut="Beyond chatbots: How to build autonomous AI agents with LangGraph that can plan, use tools, and execute complex workflows in real-world business scenarios.",dt=`# Agentic AI in Production: From Research Hype to Business Reality
...
`,mt="2025-01-15",pt=9,ft={name:"Abhishek",photo:"/Abhishek_Profile.png"},gt="AI Agents",_t=["Agents","LangGraph","AI Engineering","Production"],ht="/blog/agentic-ai.png",yt=!1,vt={id:it,slug:lt,title:ct,excerpt:ut,content:dt,publishedAt:mt,readTime:pt,author:ft,category:gt,tags:_t,featuredImage:ht,featured:yt},bt="13",xt="production-ai-observability",At="Production AI Observability: Monitoring, Logging, and Debugging",wt="A deep dive into observability for AI systems, covering performance monitoring, tracing, and debugging in production environments.",kt=`# Production AI Observability: Monitoring, Logging, and Debugging
...
`,Ct="2025-02-01",St=13,It={name:"Abhishek Mane",photo:"/Abhishek_Profile.png"},Lt="DevOps",Mt=["Observability","Monitoring","AI Production","DevOps","Tracing"],Pt="/blog/ai-observability.png",Tt=!1,Rt={id:bt,slug:xt,title:At,excerpt:wt,content:kt,publishedAt:Ct,readTime:St,author:It,category:Lt,tags:Mt,featuredImage:Pt,featured:Tt},Et=[Y,un,wn,Nn,jn,le,xe,qe,Ke,at,vt,Rt].sort((n,t)=>parseInt(n.id)-parseInt(t.id));function Bt(n){return Et.find(t=>t.slug===n)}export{Ft as B,zt as S,I as a,Et as b,R as c,Bt as g};
