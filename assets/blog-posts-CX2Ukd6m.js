import{j as _}from"./animation-DPP9jQnv.js";import{a as k,c as C}from"./utils-CDN07tui.js";import{r as i,R as S}from"./react-vendor-B2xCQPYh.js";const y=e=>typeof e=="boolean"?`${e}`:e===0?"0":e,v=k,I=(e,t)=>n=>{var o;if(t?.variants==null)return v(e,n?.class,n?.className);const{variants:r,defaultVariants:s}=t,c=Object.keys(r).map(a=>{const u=n?.[a],d=s?.[a];if(u===null)return null;const p=y(u)||y(d);return r[a][p]}),l=n&&Object.entries(n).reduce((a,u)=>{let[d,p]=u;return p===void 0||(a[d]=p),a},{}),m=t==null||(o=t.compoundVariants)===null||o===void 0?void 0:o.reduce((a,u)=>{let{class:d,className:p,...x}=u;return Object.entries(x).every(w=>{let[h,g]=w;return Array.isArray(g)?g.includes({...s,...l}[h]):{...s,...l}[h]===g})?[...a,d,p]:a},[]);return v(e,c,m,n?.class,n?.className)},L=I("inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",{variants:{variant:{default:"border-transparent bg-primary text-primary-foreground shadow hover:bg-primary/80",secondary:"border-transparent bg-secondary text-secondary-foreground hover:bg-secondary/80",destructive:"border-transparent bg-destructive text-destructive-foreground shadow hover:bg-destructive/80",outline:"text-foreground"}},defaultVariants:{variant:"default"}});function Ft({className:e,variant:t,...n}){return _.jsx("div",{className:C(L({variant:t}),e),...n})}function b(e,t){if(typeof e=="function")return e(t);e!=null&&(e.current=t)}function M(...e){return t=>{let n=!1;const o=e.map(r=>{const s=b(r,t);return!n&&typeof s=="function"&&(n=!0),s});if(n)return()=>{for(let r=0;r<o.length;r++){const s=o[r];typeof s=="function"?s():b(e[r],null)}}}}var T=Symbol.for("react.lazy"),f=S[" use ".trim().toString()];function P(e){return typeof e=="object"&&e!==null&&"then"in e}function A(e){return e!=null&&typeof e=="object"&&"$$typeof"in e&&e.$$typeof===T&&"_payload"in e&&P(e._payload)}function R(e){const t=E(e),n=i.forwardRef((o,r)=>{let{children:s,...c}=o;A(s)&&typeof f=="function"&&(s=f(s._payload));const l=i.Children.toArray(s),m=l.find(D);if(m){const a=m.props.children,u=l.map(d=>d===m?i.Children.count(a)>1?i.Children.only(null):i.isValidElement(a)?a.props.children:null:d);return _.jsx(t,{...c,ref:r,children:i.isValidElement(a)?i.cloneElement(a,void 0,u):null})}return _.jsx(t,{...c,ref:r,children:s})});return n.displayName=`${e}.Slot`,n}var zt=R("Slot");function E(e){const t=i.forwardRef((n,o)=>{let{children:r,...s}=n;if(A(r)&&typeof f=="function"&&(r=f(r._payload)),i.isValidElement(r)){const c=F(r),l=N(s,r.props);return r.type!==i.Fragment&&(l.ref=o?M(o,c):c),i.cloneElement(r,l)}return i.Children.count(r)>1?i.Children.only(null):null});return t.displayName=`${e}.SlotClone`,t}var q=Symbol("radix.slottable");function D(e){return i.isValidElement(e)&&typeof e.type=="function"&&"__radixId"in e.type&&e.type.__radixId===q}function N(e,t){const n={...t};for(const o in t){const r=e[o],s=t[o];/^on[A-Z]/.test(o)?r&&s?n[o]=(...l)=>{const m=s(...l);return r(...l),m}:r&&(n[o]=r):o==="style"?n[o]={...r,...s}:o==="className"&&(n[o]=[r,s].filter(Boolean).join(" "))}return{...e,...n}}function F(e){let t=Object.getOwnPropertyDescriptor(e.props,"ref")?.get,n=t&&"isReactWarning"in t&&t.isReactWarning;return n?e.ref:(t=Object.getOwnPropertyDescriptor(e,"ref")?.get,n=t&&"isReactWarning"in t&&t.isReactWarning,n?e.props.ref:e.props.ref||e.ref)}const z="6",B="building-rag-system-python-chromadb",O="Building a Production-Ready RAG System with Python and ChromaDB",G="Learn how to build an intelligent document processing system using Retrieval-Augmented Generation, ChromaDB vector database, and Phi-3 LLM for accurate AI-powered summaries.",H=`# Building a Production-Ready RAG System
...
`,$="/blog/rag-system.png",U={name:"Abhishek Mane",photo:"/Abhishek_Profile.png"},W="2024-12-20",V=8,K="AI/ML",Q=["RAG","Python","ChromaDB","LLM","AI"],j=!1,Y={id:z,slug:B,title:O,excerpt:G,content:H,featuredImage:$,author:U,publishedAt:W,readTime:V,category:K,tags:Q,featured:j},J="2",X="fastapi-production-best-practices",Z="FastAPI in Production: Best Practices and Lessons Learned",ee="Practical insights from building and deploying FastAPI applications at scale, including async patterns, error handling, security, and performance optimization.",ne=`# FastAPI in Production: Best Practices
...
`,te="/blog/fastapi.png",re={name:"Abhishek Mane",photo:"/Abhishek_Profile.png"},se="2024-11-15",oe=10,ae="Backend",ie=["FastAPI","Python","Backend","API","Performance"],le=!0,ce={id:J,slug:X,title:Z,excerpt:ee,content:ne,featuredImage:te,author:re,publishedAt:se,readTime:oe,category:ae,tags:ie,featured:le},ue="4",de="multi-agent-systems-langgraph-guide",me="Building Production-Ready Multi-Agent Systems with LangGraph",pe="A comprehensive technical guide to orchestrating specialized AI agents using LangGraph and LangChain for scalable, stateful production workflows.",fe=`# Building Production-Ready Multi-Agent Systems with LangGraph: A Complete Technical Guide
...
`,ge="/blog/multi-agent-systems.png",_e={name:"Abhishek Mane",photo:"/Abhishek_Profile.png"},he="2025-01-15",ye=12,ve="AI/ML",be=["LangGraph","Multi-Agent","Python","AI Architecture","LangChain"],Ae=!0,xe={id:ue,slug:de,title:me,excerpt:pe,content:fe,featuredImage:ge,author:_e,publishedAt:he,readTime:ye,category:ve,tags:be,featured:Ae},we="9",ke="production-architecture-nginx-fastapi",Ce="Production-Ready AI Architecture: Nginx, FastAPI, and DNS Integration",Se="A technical blueprint for deploying AI applications with high availability, secure DNS, and efficient load balancing using Nginx and FastAPI.",Ie=`# System Architecture for Production AI Applications: Complete Guide to Nginx, FastAPI, and DNS Integration
...
`,Le="2025-02-05",Me=10,Te={name:"Abhishek Mane",photo:"/Abhishek_Profile.png"},Pe="Infrastructure",Re=["Nginx","FastAPI","DevOps","Production","Architecture"],Ee="/blog/Guide_to_Nginx_FastAPI_and_DNS_Integration.png",qe=!1,De={id:we,slug:ke,title:Ce,excerpt:Se,content:Ie,publishedAt:Le,readTime:Me,author:Te,category:Pe,tags:Re,featuredImage:Ee,featured:qe},Ne="10",Fe="context-engineering-guide",ze="Context Engineering: The Architect's Guide to Intelligent Information Management",Be="Learn how to master context engineering to build smarter, more reliable AI systems that understand intent and provide relevant, grounded responses.",Oe=`# Context Engineering: The Architect's Guide to Intelligent Information Management for AI Systems
...
`,Ge="2025-02-04",He=15,$e={name:"Abhishek Mane",photo:"/Abhishek_Profile.png"},Ue="AI/ML",We=["Context Engineering","RAG","LLM","Data Pipeline","AI Strategy"],Ve="/blog/context-engineering.png",Ke=!1,Qe={id:Ne,slug:Fe,title:ze,excerpt:Be,content:Oe,publishedAt:Ge,readTime:He,author:$e,category:Ue,tags:We,featuredImage:Ve,featured:Ke},je="5",Ye="enterprise-rag-systems-guide",Je="Building Enterprise-Grade RAG Systems: From Prototype to Production",Xe="A comprehensive guide to building scalable, reliable RAG systems using LangChain, Azure AI Foundry, and hybrid search techniques for production environments.",Ze=`# Building Enterprise-Grade RAG Systems: From Prototype to Production
...
\`\`\`mermaid
graph TD
    QUERY((USER QUERY)) --> PROC[Query Processing]
    subgraph "Processing Layer"
        PROC --> ID[Intent Detection]
        PROC --> QE[Query Expansion]
        PROC --> MF[Metadata Filtering]
    end
    
    ID & QE & MF --> SEARCH[Hybrid Search]
    
    subgraph "Retrieval Layer"
        SEARCH --> DENSE[Dense Search / Vector DB]
        SEARCH --> SPARSE[Sparse Search / BM25]
    end
    
    DENSE & SPARSE --> RERANK[Reranking]
    RERANK --> CONTEXT[Context Construction]
    CONTEXT --> LLM[LLM Generation]
    LLM --> VALID[Response Validation]
    VALID --> ANSWER((FINAL ANSWER))
\`\`\`
...
graph TD
    subgraph "Cloud Infrastructure"
        AFD[Azure Front Door / WAF] --> AKS[Azure Kubernetes Service]
        
        subgraph "Backend Services"
            AKS --> API[FastAPI RAG API]
        end
        
        subgraph "Storage & AI"
            API --> COSMOS[Cosmos DB Vector Store]
            API --> AI[Azure AI Foundry LLMs]
            API --> REDIS[Redis Cache]
        end
        
        API --> MON[App Insights]
    end
\`\`\`
...
`,en="/blog/enterprise-rag.png",nn={name:"Abhishek Mane",photo:"/Abhishek_Profile.png"},tn="2025-01-28",rn=12,sn="AI/ML",on=["RAG","LangChain","Azure AI","Vector DB"],an=!1,ln={id:je,slug:Ye,title:Je,excerpt:Xe,content:Ze,featuredImage:en,author:nn,publishedAt:tn,readTime:rn,category:sn,tags:on,featured:an},cn="1",un="llmops-production-guide",dn="LLMOps: Engineering Production-Grade AI Systems That Actually Work",mn="Master the lifecycle of Large Language Model operations, from prompt versioning and automated evaluation to canary deployments and cost optimization.",pn=`# LLMOps: Engineering Production-Grade AI Systems That Actually Work
...
\`\`\`mermaid
graph TD
    subgraph "LLMOps Lifecycle"
        DEV["DEVELOPMENT"] --> DEP["DEPLOYMENT"]
        DEP --> MON["MONITORING"]
        MON --> OPT["OPTIMIZATION"]
        OPT --> DEV
    end

    DEV --- DEV_DESC["• Prompt Engineering<br/>• Model Selection<br/>• Eval Datasets<br/>• Version Control"]
    DEP --- DEP_DESC["• CI/CD Pipelines<br/>• A/B Testing<br/>• Canary Deploys<br/>• Rollbacks"]
    OPT --- OPT_DESC["• Cost Tracking<br/>• Performance Tuning<br/>• Prompt Refinement<br/>• Model Updates"]
\`\`\`
...
`,fn={name:"Abhishek",photo:"/Abhishek_Profile.png"},gn="2025-01-25",_n=10,hn="LLMOps",yn=["LLMOps","Production","Monitoring","Azure"],vn="/blog/llmops-production.png",bn=!0,An={id:cn,slug:un,title:dn,excerpt:mn,content:pn,author:fn,publishedAt:gn,readTime:_n,category:hn,tags:yn,featuredImage:vn,featured:bn},xn="11",wn="multimodal-ai-architecture",kn="Multimodal AI Systems: Architecture for Vision, Language, and Beyond",Cn="A deep dive into building AI systems that can see, hear, and speak, exploring the architecture and implementation of multimodal models.",Sn=`# Multimodal AI Systems: Architecture for Vision, Language, and Beyond
...
`,In="2025-01-30",Ln=11,Mn={name:"Abhishek Mane",photo:"/Abhishek_Profile.png"},Tn="Computer Vision",Pn=["Multimodal","Computer Vision","NLP","AI Architecture","Azure"],Rn="/blog/multimodal-ai.png",En=!1,qn={id:xn,slug:wn,title:kn,excerpt:Cn,content:Sn,publishedAt:In,readTime:Ln,author:Mn,category:Tn,tags:Pn,featuredImage:Rn,featured:En},Dn="12",Nn="ai-agent-protocols-mcp",Fn="AI Agent Communication Protocols: MCP, Tool Integration, and Standards",zn="Exploring the Model Context Protocol (MCP) and other standards that enable AI agents to communicate and share tools across different platforms.",Bn=`# AI Agent Communication Protocols: MCP, Tool Integration, and Standards
...
`,On="2025-02-06",Gn=9,Hn={name:"Abhishek Mane",photo:"/Abhishek_Profile.png"},$n="AI Frameworks",Un=["MCP","AI Agents","Protocols","Standards","Tool Integration"],Wn="/blog/ai-agent-protocols.png",Vn=!1,Kn={id:Dn,slug:Nn,title:Fn,excerpt:zn,content:Bn,publishedAt:On,readTime:Gn,author:Hn,category:$n,tags:Un,featuredImage:Wn,featured:Vn},Qn="7",jn="small-language-models-efficiency",Yn="Small Language Models: Building Efficient AI That Actually Ships",Jn="Discover why smaller is often better. A technical deep dive into fine-tuning 1-10B parameter models like Phi-3.5 and Llama 3.2 for specialized, low-latency tasks.",Xn=`# Small Language Models: Building Efficient AI That Actually Ships
...
`,Zn="2025-01-20",et=8,nt={name:"Abhishek",photo:"/Abhishek_Profile.png"},tt="Edge AI",rt=["SLM","Edge AI","Optimization","Phi-3.5"],st="/blog/small-language-models.png",ot=!1,at={id:Qn,slug:jn,title:Yn,excerpt:Jn,content:Xn,publishedAt:Zn,readTime:et,author:nt,category:tt,tags:rt,featuredImage:st,featured:ot},it="14",lt="agentic-ai-production-guide",ct="Agentic AI in Production: From Research Hype to Business Reality",ut="Master the architecture of autonomous AI agents. Learn to build reliable, goal-oriented systems using ReAct patterns, multi-agent coordination, and production-grade tool integration.",dt=`# Agentic AI in Production: From Research Hype to Business Reality
...
\`\`\`mermaid
graph TD
    START((START)) --> OBS1[1. OBSERVE]
    OBS1 --> REA[2. REASON]
    REA --> ACT[3. ACT]
    ACT --> OBS2[4. OBSERVE RESULTS]
    OBS2 --> GOAL{Goal Reached?}
    GOAL -- No --> OBS1
...
`,mt={name:"Abhishek",photo:"/Abhishek_Profile.png"},pt="2025-01-20",ft=15,gt="Agentic AI",_t=["AI Agents","ReAct","LangChain","Autonomy"],ht="/blog/agentic-ai.png",yt=!1,vt={id:it,slug:lt,title:ct,excerpt:ut,content:dt,author:mt,publishedAt:pt,readTime:ft,category:gt,tags:_t,featuredImage:ht,featured:yt},bt="13",At="production-ai-observability",xt="Production AI Observability: Monitoring, Logging, and Debugging",wt="A deep dive into observability for AI systems, covering performance monitoring, tracing, and debugging in production environments.",kt=`# Production AI Observability: Monitoring, Logging, and Debugging
...
`,Ct="2025-02-01",St=13,It={name:"Abhishek Mane",photo:"/Abhishek_Profile.png"},Lt="DevOps",Mt=["Observability","Monitoring","AI Production","DevOps","Tracing"],Tt="/blog/ai-observability.png",Pt=!1,Rt={id:bt,slug:At,title:xt,excerpt:wt,content:kt,publishedAt:Ct,readTime:St,author:It,category:Lt,tags:Mt,featuredImage:Tt,featured:Pt},Et=[Y,ce,xe,De,Qe,ln,An,qn,Kn,at,vt,Rt].sort((e,t)=>parseInt(e.id)-parseInt(t.id));function Bt(e){return Et.find(t=>t.slug===e)}export{Ft as B,zt as S,I as a,Et as b,R as c,Bt as g};
