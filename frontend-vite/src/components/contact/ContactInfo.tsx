import { Mail, MapPin, Calendar, Copy, Check } from 'lucide-react'
...
export default function ContactInfo() {
    ...
    const email = 'abhishekmane@example.com' // Replace with actual email
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="space-y-4">
                {/* Email */}
                <div className="flex items-start gap-4 p-4 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 transition-colors group">
            ...
            {/* Social links */}
            <div>
                <div className="text-sm font-medium text-muted-foreground mb-3">Connect with me</div>
            ...
            <div className="p-6 rounded-xl bg-gradient-to-br from-blue-500/10 to-purple-500/10 border border-white/10">
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-white/10 hover:bg-white/20 border border-white/20 text-foreground font-medium text-sm transition-all"
                >
